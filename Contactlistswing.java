...
public class Contactlistswing extends JFrame {
			...
			try {
				...
				for (q = 0; q < e; q++) {
					...
					try {
						...
						JOptionPane.showMessageDialog(frame, "Special events exceeding 100 characters");
					}
					...
					try {
						...
						JOptionPane.showMessageDialog(frame, "context exceeding 100 characters");
					}
				...
				for (q = 0; q < e; q++) {
					...
					try {
						...
						JOptionPane.showMessageDialog(frame, "Professional interests exceeding 100 characters");
					}
				...
				for (q = 0; q < e; q++) {
					...
					try {
						...
						JOptionPane.showMessageDialog(frame, "when and where exceeding 100 characters");
					}
					...
					try {
						...
						JOptionPane.showMessageDialog(frame, "Circumstances exceeding 100 characters");
					}
					ccheck.setCircums(p);
					...
					try {
						...
						JOptionPane.showMessageDialog(frame, "Useful info exceeding 100 characters");
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					Contactlistswing window = new Contactlistswing();
	...
	public Contactlistswing() {
		...
		frame.getContentPane().add(Parts, BorderLayout.NORTH);
			...
			public void actionPerformed(ActionEvent e) {
				...
				while (j > 0) {
					...
					if (fn.compareTo(one) == 0) {
						...
						Data.setVisible(false);
						j = 0;
						JOptionPane.showMessageDialog(frame, "Wrong Choice Entered .Enter correct choice");
					}
...
output=null;
						...
						JOptionPane.showMessageDialog(frame, "Enter correct choice");
						j = 0;
					}
				}
				frame.setVisible(true);
